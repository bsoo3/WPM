...
const pharagraphs = [
    ...
    `One can cook on and with an open fire. These are some of the ways to cook with fire outside.`,
...
const keyListener = document.addEventListener("keydown", ({ key }) => {
    ...
    if (key === cursorCharacter.innerText) {
        cursorCharacter.classList.remove("false");
        cursorCharacter.classList.remove("cursor");
        cursorCharacter.classList.add("true");
        cursorCharacter = characters[++cursorIndex];
    } else {
        console.log("Hello");
        cursorCharacter.classList.add("false");
    }
